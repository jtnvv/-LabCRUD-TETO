                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex flex-col">
                                <label htmlFor="alcalde" className="mb-2">Editar alcalde</label>
                                <input id="alcalde" type="text" value={idalcalde} onChange={e => setAlcalde(e.target.value)} placeholder="Documento del nuevo alcalde" className="p-2 border rounded" />
                            </div>
                            <div className="flex flex-col">
