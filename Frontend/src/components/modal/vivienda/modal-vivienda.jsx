                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="flex flex-col">
                                <label htmlFor="propietario" className="mb-2">Propietario</label>
                                <input id="propietario" type="text" value={propietario} onChange={e => setPropietario(e.target.value)} placeholder="Propietario" className="p-2 border rounded" />
                            </div>
                            <div className="flex flex-col">
